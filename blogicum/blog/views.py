...
from .forms import CommentForm, PostForm, CustomUserChangeForm, RegistrationForm
...
def category_posts(request, category_slug):
    ...
    post_list = Post.objects.filter(category=category).with_comment_count()
    post_list = filter_published_posts(post_list).order_by('-pub_date')
...
def profile(request, username):
    ...
    posts = user.posts.with_comment_count().order_by('-pub_date')
